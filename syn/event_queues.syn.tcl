...
# Set top level name
set top_level "event_queues"

# Read verilog files
read_file -f sverilog [list  "../verilog/standard.vh ../verilog/CU_fifo.sv ../verilog/priority_arbiter.sv ../pe/verilog/fp_add.sv ../verilog/coalescing_unit.sv ../verilog/bin_func.sv ../verilog/event_queues.sv "]
list_designs
