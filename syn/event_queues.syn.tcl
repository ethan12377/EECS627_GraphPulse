...
# Read verilog files
read_file -f sverilog [list  "../verilog/standard.vh ../verilog/CU_fifo.sv ../verilog/priority_arbiter.sv ../verilog/fp_add.sv ../verilog/coalescing_unit.sv ../verilog/bin_func.sv ../verilog/event_queues.sv "]
list_designs
