...
# Set top level name
set top_level "GraphPulse"

# Read verilog files
read_file -f sverilog "../verilog/standard.vh ../verilog/graphpulse.v ../verilog/center.sv ../verilog/EQ_wrapper_half.sv ../verilog/priority_arbiter.sv ../verilog/rr_arbiter.sv ../verilog/fp_add.sv ../verilog/fp_div.sv ../verilog/fp_mul.sv ../verilog/fpu.sv ../verilog/mc.sv ../verilog/int16_to_float16.sv ../verilog/pe.sv ../verilog/Xbar_SchedToPE.sv ../verilog/PE_Freelist.sv ../verilog/Xbar_PEToQ.sv ../verilog/output_buffer.sv ../verilog/OB_bubble_squeezer.sv ../verilog/OB_fifo.sv ../verilog/coalescing_unit.sv ../verilog/bin_func.sv ../verilog/event_queues_half.sv ../verilog/queue_scheduler.sv ../verilog/CU_fifo.sv"
list_designs
